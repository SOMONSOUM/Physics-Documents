...
\titlecontents{subsection}[0.85cm] % Indentation
{\addvspace{0.7pt}\sffamily\small\kbk} % Spacing and font options for subsections
{\contentslabel[\thecontentslabel]{0.85cm}} % Subsection number
{}
...
{\addvspace{10pt}\large\sffamily\bfseries\kml} % Spacing and font options for chapters
{\color{ocre}\contentslabel[\Large\thecontentslabel\kml]{0.85cm}\color{ocre}} % Chapter number
{}  
...
{\contentslabel[\thecontentslabel]{0.85cm}} % Section number
{}
{}
...
\newtheorem{generalT}[dummy]{\kml ជាទូទៅ}
\theoremstyle{ocrenum}
...
\begin{list}{}{
\leftmargin=15pt % Indentation on the left
