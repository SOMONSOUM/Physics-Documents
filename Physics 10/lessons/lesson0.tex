...
%					\draw (B)--(H);
		...
		\end{figure}
	\end{multicols}
	\item \emph{\kml ត្រីកោណសមបាត} គេមានត្រីកោណកែងសមបាត $ABC$ ដូចរូប។ យើងបាន
	\begin{multicols}{2}
		\begin{align*}
...
\begin{multicols}{2}
	...
	\begin{figure}[H]
		...
		\coordinate[label=below:{\text{\ak ជ្រុងជាប់}}] (1.5,0) at (1.5,0);
		\coordinate[label=right:{\text{\ak ជ្រុងឈម}}] (3,1) at (3,1);
		\coordinate[label=right:{\text{\ak អុីប៉ូតេនុស}}] (-1,1) at (-1,1);
		\end{scope}
		\end{tikzpicture}
