...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{.5\textwidth}
		...
		\begin{scope}
		\fill [yellow!80!orange] (1,0) -- (1,2) -- (3,2) -- (3,0) -- cycle;
...
\begin{enumerate}[m]
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[t]{.3\textwidth}
			...
			\begin{scope}
				\fill [black!50!white] (1,0) -- (1,2) -- (3,2) -- (3,0) -- cycle;
				\pattern[pattern color=white,pattern=bricks] (1,0) -- (1,2) -- (3,2) -- (3,0) -- cycle;
				\coordinate (O) at (0, 0);
				\coordinate (P) at (0, 2.7);
				\draw (0,0)-- (4,0);
