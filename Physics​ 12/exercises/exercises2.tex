...
\begin{enumerate}[m]
		...
		\item គេសន្មត់ថាឧស្ម័នមួយនៅក្នុងសុីឡាំងដែលត្រូវបានបិទជិតដោយពីស្តុងមួយ អាចរីកមាឌក្រោមសម្ពាធថេរ $500kPa$ ពី​ $10\ell$ ទៅ $25\ell$។ គណនាកម្មន្តដែលបំពេញដោយឧស្ម័ននោះ។
		...
		\begin{figure}[H]
			...
			\draw(1,-.3) node [color=blue]{$2.0 \ell$};
			\draw(2.5,-.3) node [color=blue]{$4.0 \ell$};
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[t]{.5\textwidth}
			...
			\draw(4,0) node [color=blue, right=.1cm]{$V\left(\ell\right)$};
			\draw [arrows = {-Latex[width=10pt, length=10pt]}] (2,2.5) -- (2.2,2.6);
			\end{scope}
			\end{tikzpicture}
			\subcaption{\koc ក្រាប $P-V$}
	...
	\end{figure}
	\newpage
	\item ចូរគណនាកម្មន្តសរុបក្នុងរូបនីមួយៗខាងក្រោមៈ
	\begin{figure}[H]
		\begin{subfigure}[t]{.5\textwidth}
			\centering
			...
			\draw [dashed,magenta,ultra thick, ystep=1.0cm] grid (.1,4.1);
			\draw [->, -Stealth, ultra thick, ystep=1.0cm] (0,0)-- (0,4.6);
			...
			\coordinate [label=left:$8$] ($P_{4}$) at (0,4);
			\coordinate [label=left:$6$] ($P_{3}$) at (0,3);
			\coordinate [label=left:$4$] ($P_{2}$) at (0,2);
			\coordinate [label=left:$2$] ($P_{1}$) at (0,1);
			\draw [arrows = {-Latex[width=10pt,length=10pt]}] (3,2.3)--(3,2.1);
			\draw [arrows = {-Latex[width=10pt, length=10pt]}] (2,1) -- (1.8,1);
			\draw [arrows = {-Latex[width=10pt, length=10pt]}] (1.8,2.2) -- (2,2.5);
			\draw [ultra thick] (A) -- (B) -- (C) --cycle;
			\draw[dashed] (A)--(1,0);
			\draw[dashed] (A)--(0,1);
			\draw[dashed] (B)--(0,4);
			\draw[dashed] (C)--(3,0);
			\coordinate [label=below:$6$] ($5$) at (1,0);
			\coordinate [label=below:$8$] ($10$) at (2,0);
			\coordinate [label=below:$10$] ($15$) at (3,0);
			\draw [color=blue] (1,1) node {$\bullet$};
			\draw [color=blue] (3,1) node {$\bullet$};
			\draw [color=blue] (3,4) node {$\bullet$};
			\end{scope}
			\end{tikzpicture}
			\subcaption{\koc ក្រាប $P-V$}
		\end{subfigure}
		\begin{subfigure}[t]{.5\textwidth}
			...
			\begin{tikzpicture}[scale=1]
				...
				\draw [->,-Stealth, ultra thick, xstep=1.0cm] (0,0)-- (4.6,0);
				...
				\coordinate [label=above:$P\left(10^{5}Pa\right)$] ($P$) at (0,3.5);
				\coordinate [label=left:$6$] ($P_{3}$) at (0,3);
				\coordinate [label=left:$4$] ($P_{2}$) at (0,2);
				\coordinate [label=left:$2$] ($P_{1}$) at (0,1);
				\draw [arrows = {-Latex[width=10pt,length=10pt]}] (3.47,2.3)--(3.3,2.1);
				\draw [arrows = {-Latex[width=10pt, length=10pt]}] (2.5,3) -- (2.7,3);
				\draw [arrows = {-Latex[width=10pt, length=10pt]}] (1.7,2.1) -- (1.5,2.3);
				\draw [ultra thick] (A) -- (B) -- (C) --cycle;
				\coordinate [label=below:$1$] ($1$) at (1,0);
				\coordinate [label=below:$2$] ($2$) at (2,0);
				\coordinate [label=below:$3$] ($3$) at (3,0);
				\coordinate [label=below:$4$] ($4$) at (4,0);
				\draw [color=blue] (2.5,1) node {$\bullet$};
				\draw [color=blue] (1,3) node {$\bullet$};
				\draw [color=blue] (4,3) node {$\bullet$};
				\end{scope}
			\end{tikzpicture}
			\subcaption{\koc ក្រាប $P-V$}
		\end{subfigure}
		\begin{subfigure}[t]{.5\textwidth}
			...
			\begin{tikzpicture}[scale=1]
				...
				\coordinate [label=left:$4$] ($P_{2}$) at (0,2);
				\coordinate [label=left:$2$] ($P_{1}$) at (0,1);
				\draw [arrows = {-Latex[width=10pt,length=10pt]}] (1,2.3)--(1,2.5);
				...
				\draw [color=blue] (1,1) node {$\bullet$};
				\draw [color=blue] (1,3) node {$\bullet$};
				\draw [color=blue] (3,3) node {$\bullet$};
				\end{scope}
			\end{tikzpicture}
			\subcaption{\koc ក្រាប $P-V$}
		\end{subfigure}
		\begin{subfigure}[t]{.5\textwidth}
			...
			\begin{tikzpicture}[scale=1]
				\begin{scope}
				\draw [dashed,magenta, ultra thick, xstep=1.0cm] grid (6.1,.1);
				\draw [dashed,magenta,ultra thick, ystep=1.0cm] grid (.1,4.1);
				\draw [->, -Stealth, ultra thick, ystep=1.0cm] (0,0)-- (0,4.6);
				\draw [->,-Stealth, ultra thick, xstep=1.0cm] (0,0)-- (6.6,0);
				\coordinate [label=above:$A$] (A) at (1,1);
				\coordinate [label=above:$B$] (B) at (6,1);
				\coordinate [label=right:$V\left(m^{3}\right)$] ($V$) at (6.5,0);
				\coordinate [label=above:$P\left(kPa\right)$] ($P$) at (0,4.5);
				\coordinate [label=left:$4$] ($P_{4}$) at (0,4);
				\coordinate [label=left:$3$] ($P_{3}$) at (0,3);
				\coordinate [label=left:$2$] ($P_{2}$) at (0,2);
				\coordinate [label=left:$1$] ($P_{1}$) at (0,1);
				\draw [arrows = {-Latex[width=10pt,length=10pt]}] (3.5,4)--(3.7,4);
				\draw [arrows = {-Latex[width=10pt, length=10pt]}] (1.5,1) -- (1.7,1);
				\draw [arrows = {-Latex[width=10pt, length=10pt]}] (5.5,1) -- (5.7,1);
				\draw [arrows = {-Latex[width=10pt, length=10pt]}] (4.51,2.5) -- (4.6,2.25);
				\draw [ultra thick] (A) --(2,1)--(3,4)--(4,4) --(5,1)-- (B);
				\coordinate [label=below:$1$] ($1$) at (1,0);
				\coordinate [label=below:$2$] ($2$) at (2,0);
				\coordinate [label=below:$3$] ($3$) at (3,0);
				\coordinate [label=below:$4$] ($4$) at (4,0);
				\coordinate [label=below:$5$] ($5$) at (5,0);
				\coordinate [label=below:$6$] ($6$) at (6,0);
				\draw [color=blue] (A) node {$\bullet$};
				\draw [color=blue] (B) node {$\bullet$};
				\end{scope}
			\end{tikzpicture}
			\subcaption{\koc ក្រាប $P-V$}
		\end{subfigure}
		\begin{subfigure}[t]{.5\textwidth}
			...
			\coordinate [label=right:$V\left(m^{3}\right)$] ($V$) at (3.5,0);
			\coordinate [label=above:$P\left(10^{5}Pa\right)$] ($P$) at (0,4.5);
			\coordinate [label=left:$4$] ($P_{4}$) at (0,4);
			\coordinate [label=left:$3$] ($P_{3}$) at (0,3);
			\coordinate [label=left:$2$] ($P_{2}$) at (0,2);
			\coordinate [label=left:$1$] ($P_{1}$) at (0,1);
			\draw [arrows = {-Latex[width=10pt, length=10pt]}] (2.5,3) -- (2.6,2.8);
			\draw [arrows = {-Latex[width=10pt, length=10pt]}] (1.4,2.8) -- (1.5,3);
			\draw [ultra thick] (A) --(C)-- (B);
			\coordinate [label=below:$1$] ($1$) at (1,0);
			\coordinate [label=below:$2$] ($2$) at (2,0);
			\coordinate [label=below:$3$] ($3$) at (3,0);
			\draw [color=blue] (A) node {$\bullet$};
			\draw [color=blue] (B) node {$\bullet$};
			\draw [color=blue] (C) node {$\bullet$};
			\end{scope}
			\end{tikzpicture}
			\subcaption{\koc ក្រាប $P-V$}
		\end{subfigure}
		\begin{subfigure}[t]{.5\textwidth}
			...
			\coordinate [label=below right:$C$] (C) at (3,1);
			\coordinate [label=right:$V\left(\ell\right)$] ($V$) at (3.5,0);
			\coordinate [label=above:$P\left(atm\right)$] ($P$) at (0,4.5);
			\coordinate [label=left:$5$] ($P_{5}$) at (0,4);
			\coordinate [label=left:$1$] ($P_{1}$) at (0,1);
			\draw [arrows = {-Latex[width=10pt,length=10pt]}] (1,2.5)--(1,2.7);
			\draw [arrows = {-Latex[width=10pt, length=10pt]}] (2,1) -- (1.8,1);
			\draw [arrows = {-Latex[width=10pt, length=10pt]}] (2,2.5) -- (2.1,2.3);
			\draw [ultra thick] (A) -- (B) -- (C) --cycle;
			\draw[dashed] (A)--(1,0);
			\draw[dashed] (A)--(0,1);
			\draw[dashed] (B)--(0,4);
			\draw[dashed] (C)--(3,0);
			\coordinate [label=below:$10$] ($10$) at (1,0);
			\coordinate [label=below:$50$] ($50$) at (3,0);
			\draw [color=blue] (A) node {$\bullet$};
			\draw [color=blue] (B) node {$\bullet$};
			\draw [color=blue] (C) node {$\bullet$};
			\end{scope}
...
%		\draw (1,1) node {$\bullet$};
		...
		\end{tikzpicture}
	\end{figure}
	\item ឧស្ម័នគំរូមួយបានរីកមាឌពី $3\ell$ ទៅ $12\ell$ នៅពេលដែលសម្ពាធវាថយចុះពី $6atm$ ទៅ $1.5atm$។ គណនាកម្មន្តបំពេញដោយឧស្ម័នតាមគន្លងនីមួយៗដូចបង្ហាញក្នុងរូបៈ
	\begin{multicols}{2}
			\begin{enumerate}
				\item តាមគន្លង $ABC$
				\item តាមគន្លងពី $A$ ទៅ $C$
				\item តាមគន្លង $ADC$។
		\end{enumerate}
		\begin{figure}[H]
			\centering
			...
			\begin{scope}[line width=2pt]
			\draw [dashed, line width=1.5pt, xstep=.8cm,ystep=.8cm] grid (3.8,3.8);
			\draw [->, -Stealth, ultra thick, ystep=1.0cm] (0,0)-- (0,3.8);
			\draw [->,-Stealth, ultra thick, xstep=1.0cm] (0,0)-- (3.8,0);
			\coordinate [label=above left:$A$] (A) at (.8,3.2);
			\coordinate [label=above right:$B$] (B) at (3.2,3.2);
			\coordinate [label=below right:$C$] (C) at (3.2,.8);
			\coordinate [label=below left:$D$] (D) at (.8,.8);
			\coordinate [label=right:$V\left(\ell\right)$] ($V$) at (3.8,0);
			\coordinate [label=below:$3$] ($V_{1}$) at (.8,0);
			\coordinate [label=below:$12$] ($V_{2}$) at (3.2,0);
			\coordinate [label=above:$P\left(atm\right)$] ($P$) at (0,3.8);
			\coordinate [label=left:$6$] ($P_{1}$) at (0,3.2);
			\coordinate [label=left:$1.5$] ($P_{2}$) at (0,.8);
			\draw[fill=white] (A)--(B)--(C)--(D)--cycle;
			\draw [color=magenta, ultra thick] (.8,3.2) -- (3.2,.8);
			\draw [color=magenta, arrows = {-Latex[width=10pt, length=10pt]}] (.8,2) -- (.8,1.8);
			\draw [color=magenta, arrows = {-Latex[width=10pt, length=10pt]}] (2,.8) -- (2.2, .8);
			\draw [color=magenta, arrows = {-Latex[width=10pt,length=10pt]}] (1.8,2.2)--(2.2,1.8);
			\draw [color=magenta, arrows = {-Latex[width=10pt,length=10pt]}] (2,3.2)--(2.2,3.2);
			\draw [color=magenta, arrows = {-Latex[width=10pt, length=10pt]}] (3.2,2) -- (3.2,1.8);
			\end{scope}
			\end{tikzpicture}
		\end{figure}
	\end{multicols}
	\item ដ្យាក្រាម $\left(P-V\right)$ ដែលបង្ហាញដូចរូប តាងបម្រែបម្រួលមាឌ និងសម្ពាធរបស់ឧស្ម័នក្នុងស៊ីឡាំងនៃពិស្តុងម៉ាស៊ីនមួយ។ ចូរគណនាៈ
	\begin{multicols}{2}
		\begin{enumerate}
			\item គណនាកម្មន្តសរុបក្នុងបម្លែងបិទនេះ។
			\item គណនាថាមពលកម្តៅសរុបក្នុងបម្លែងបិទនេះ
			\item ចូរបម្លែងពីដ្យាក្រាម $\left(P-V\right)$ ទៅជា $\left(P-T\right)$ និងដ្យាក្រាម $\left(V-T\right)$។
		\end{enumerate}
		\begin{figure}[H]
			\centering
			\begin{tikzpicture}[xscale=1.5]
			...
			\coordinate [label=below right:$C$] (C) at (3,1);
			\coordinate [label=below left:$D$] (D) at (1,1);
			\coordinate [label=below:$20.0$] ($V_{1}$) at (1,0);
			\coordinate [label=below:$50.0$] ($V_{2}$) at (3,0);
			\coordinate [label=left:$8.0$] ($P_{2}$) at (0,3);
			\coordinate [label=left:$3.0$] ($P_{1}$) at (0,1);
			\coordinate [label=right:$V\left(\ell\right)$] ($V$) at (3.7,0);
			\coordinate [label=left:$P\left(atm\right)$] ($P$) at (0,3.5);
			\draw [color=magenta, arrows = {-Latex[width=10pt, length=10pt]}] (1,2) -- (1,2.2);
			\draw [color=magenta, arrows = {-Latex[width=10pt,length=10pt]}] (2,3)--(2.2,3);
			\draw [color=green!40!black, arrows = {-Latex[width=10pt, length=10pt]}] (2.2,1) -- (2, 1);
			\draw [color=green!40!black, arrows = {-Latex[width=10pt, length=10pt]}] (3,2.2) -- (3,2);
			\draw [color=black] (1,1) node {$\bullet$};
			\draw [color=black] (1,3) node {$\bullet$};
			\draw [color=black] (3,3) node {$\bullet$};
			\draw [color=black] (3,1) node {$\bullet$};
		...
		\end{figure}
	\end{multicols}
	\item ដ្យាក្រាម $\left(P-T\right)$ ក្នុងរូបតាងឲ្យវដ្តនៃម៉ាស៊ីនប្រើឧស្ម័នមួយ។ នៅទីតាំងទី១ ឧស្ម័នមានសម្ពាធ $P_{1}$ មានមាឌ $V_{1}=V_{3}=15\ell$ និងសីតុណ្ហភាព $T_{1}$។
	\begin{enumerate}
		\item ចូរបញ្ជាក់ឈ្មោះតាមលំនាំនីមួយៗក្នុងវគ្គទាំងបួននៃដំណើរការម៉ាស៊ីន។
		\item តាមដ្យាក្រាម និងការគណនា។ ចូរកំណត់សម្ពាធ មាឌ និងសីតុណ្ហភាពត្រង់ទីតាំង $2,~3,~4$។
		\item គណនាកម្មន្ត និងថាមពលកម្តៅក្នុងមួយវដ្តដំណើរការម៉ាស៊ីន។
		\item ចូរគូសដ្យាក្រាម $\left(P-V\right)$ និងដ្យាក្រាម $\left(V-T\right)$។
	\end{enumerate}
	\begin{figure}[H]
		\centering
		\begin{tikzpicture}[>=Stealth]
		...
		\draw [->,-Stealth, ultra thick, xstep=1.0cm] (0,0)-- (3.8,0);
		\coordinate [label=below:$0$] (0) at (0,0);
		\coordinate [label=above left:$1$] (A) at (.8,.8);
		\coordinate [label=above left:$2$] (B) at (.8,3.2);
		\coordinate [label=above right:$3$] (C) at (3.2,3.2);
		\coordinate [label=below right:$4$] (D) at (3.2,.8);
		\coordinate [label=right:$T\left(K\right)$] ($V$) at (3.8,0);
		\coordinate [label=below:$300$] ($T_{1}$) at (.8,0);
		\coordinate ($T_{2}$) at (3.2,0);
		\coordinate [label=above:$P\left(atm\right)$] ($P$) at (0,3.8);
		\coordinate [label=left:$3$] ($P_{1}$) at (0,3.2);
		\coordinate [label=left:$1$] ($P_{2}$) at (0,.8);
		\draw[fill=white] (A)--(B)--(C)--(D)--cycle;
		\draw [loosely dashdotted, line width=1pt] (0,0) -- (3.2,3.2);
		\draw [dashed, line width=1.5pt] (0,.8) -- (A);
		\draw [dashed, line width=1.5pt] (.8,0) -- (A);
		\draw [dashed, line width=1.5pt] (0,3.2) -- (B);
		\draw [dashed, line width=1.5pt] (3.2,0) -- (C);
		\draw [color=magenta, arrows = {-Latex[width=10pt, length=10pt]}] (.8,1.8) -- (.8,2);
		\draw [color=magenta, arrows = {-Latex[width=10pt, length=10pt]}] (2,.8) -- (1.8, .8);
		\draw [color=magenta, arrows = {-Latex[width=10pt,length=10pt]}] (2,3.2)--(2.2,3.2);
		\draw [color=magenta, arrows = {-Latex[width=10pt, length=10pt]}] (3.2,2) -- (3.2,1.8);
		\end{scope}
		\end{tikzpicture}
	\end{figure}
	\item ពិស្តុងក្នុងស៊ីឡាំងមួយមានមុខកាត់ $0.01m^{2}$។ ក្រោមសម្ពាធថេរ $7.5\times10^{5}Pa$ ពិស្តុងផ្លាស់ទីបានប្រវែង $0.04m$។ គណនាកម្មន្តដែលបានបំពេញដោយពិស្តុង។
	\item ពិស្តុងបានផ្លាស់ទីចូលក្នុងស៊ីឡាំងមួយដោយរក្សាសម្ពាធថេរ និងបានធ្វើកម្មន្តឲ្យពិស្តុង $0.84J$។ ពីស្តុងមានអង្កត់ផ្ចិត $1.6cm$ និងផ្លាស់ទីបាន $2.1cm$។ គណនាសម្ពាធថេរនោះ។ 
\end{enumerate}