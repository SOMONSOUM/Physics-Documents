\documentclass[a4paper,12pt]{styles/fancy}
...
\begin{document}
\includepdf{pdf-files/front-cover.pdf}
\frontmatter
\pagenumbering{alpkh}
%\input{introductions/knowledge.tex}
%\input{introductions/preface.tex}
\input{introductions/tableofcontents.tex}
\mainmatter
\pagenumbering{khmer}
\input{lessons/lesson1.tex}
\input{exercises/exercises1.tex}
\input{lessons/lesson2.tex}
\input{exercises/exercises2.tex}
\input{lessons/lesson3.tex}
\input{exercises/exercises3.tex}
\includepdf{pdf-files/back-cover.pdf}
\end{document}